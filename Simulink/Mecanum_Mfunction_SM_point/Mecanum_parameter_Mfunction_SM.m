...
figure();
subplot(3,1,1) ;plot(t,ERR_X);title('T-ERR X');
% subplot(3,1,2) ;plot(t,Final_X-X);title('T-ERR of Fin X');
subplot(3,1,2) ;plot(t,ERR_Y);title('T-ERR Y');
% subplot(3,2,4) ;plot(t,Final_Y-Y);title('T-ERR of Fin Y')
subplot(3,1,3) ;plot(t,ERR_PHI);title('T-ERR PHI');
