...
subplot(8,1,[1,2]);
plot(t(1:20000),X_cmd(1:20000) - X(1:20000),'b','LineWidth',3  );set(gca,'FontSize',13);;grid on;

%=== Y ===
subplot(8,1,[4,5]);
plot(t(1:20000),Y_cmd(1:20000) - Y(1:20000),'b','LineWidth',3  );set(gca,'FontSize',13);;grid on;
...
Data_PID(1:20000) = t(1:20000);
Data_PID(20001:40000) = X_cmd(1:20000);
Data_PID(40001:60000) = X(1:20000);
Data_PID(60001:80000) = Y_cmd(1:20000);
Data_PID(80001:100000) = Y(1:20000);
Data_PID(100001:120000) = 0;
Data_PID(120001:140000) = PHI(1:20000);